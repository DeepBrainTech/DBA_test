  ...
  return (
    <footer className="bg-[#2C3E50] text-white py-12 md:py-16">
      <div className="max-w-[1920px] mx-auto px-6 md:px-14">
          ...
          <div className="col-span-2">
            ...
            <div className="space-y-3 md:space-y-4">
              <div className="flex items-center gap-3">
                ...
                <span className="text-base md:text-lg text-white">914-488-4460</span>
              </div>
              <div className="flex items-center gap-3">
                <svg className="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="text-base md:text-lg text-white">info@deepbrainacademy.org</span>
              </div>
              <div className="flex items-center gap-3">
                <svg className="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-base md:text-lg text-white">120 County Rd, Suite 100-101, Tenafly, NJ</span>
              </div>
            </div>
        ...
        {/* Bottom Bar */}
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-6 md:pt-8 border-t border-[#3D4F63]">
