 ...
 * 依赖关系：next/image、types/summer_camp SummerCampFeaturedProject
 * 注意事项：图片区仅用 relative 供 Next Image fill 使用，卡片内无 absolute 定位
 */

import Image from 'next/image';
import type { SummerCampFeaturedProject } from '@/types/summer_camp';
...
export interface FeaturedProjectCardProps {
  /** 项目数据 */
  project: SummerCampFeaturedProject;
}
