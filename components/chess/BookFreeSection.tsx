...
const benefits: Benefit[] = [
    ...
    { icon: '📊', text: 'Cognitive Skills Assessment Report' },
    { icon: '📚', text: 'Digital Chess Starter Kit' },
    { icon: '🎮', text: 'Access to Interactive Chess Games' }
];
        ...
        <div className="grid grid-cols-2 gap-[60px] items-start">
          ...
          <div className="space-y-[32px]">
            ...
            <h2 className="text-[42px] font-bold text-white leading-[1.3]">
              Sharpen young minds for the future.
            </h2>

            {/* Subtitle */}
            <p className="text-[21px] text-white/90 leading-[1.6]">
               Book a free trial class now and experience our unique experience our immersive, puzzle-based method!
            </p>
