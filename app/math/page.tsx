      ...
      <section className="py-20 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl font-bold text-gray-900 mb-2">Winter and Spring Program</h2>
            <p className="text-gray-600">2025-2026 School Year</p>
          </div>

          <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
            <div className="p-8">
              <h3 className="text-2xl font-bold text-gray-900 mb-8 text-center">Chess & Go Programs</h3>
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b-2 border-gray-200">
                      ...
                      <th className="text-left py-4 px-6 font-semibold text-gray-700">Tuition</th>
                      <th className="text-left py-4 px-6 font-semibold text-gray-700">Hourly Rate</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-gray-100">
                    <tr className="hover:bg-gray-50 transition-colors">
                      <td className="py-4 px-6 text-gray-900">Mental Math &<br/>Pre-AMC Math</td>
                      <td className="py-4 px-6 text-gray-600">10 sessions - 1.5h per session<br/>20 sessions - 1.5h per session</td>
                      <td className="py-4 px-6">
                        <div className="text-green-600 font-semibold">$750</div>
                        <div className="text-green-600 font-semibold">$1600</div>
                      </td>
                      <td className="py-4 px-6 text-gray-600">$50/h<br/>$55/h</td>
                    </tr>
                    <tr className="hover:bg-gray-50 transition-colors">
                      <td className="py-4 px-6 text-gray-900">AMC 8 Math</td>
                      <td className="py-4 px-6 text-gray-600">10 sessions<br/>1.5h per session</td>
                      <td className="py-4 px-6">
                        <div className="text-green-600 font-semibold">$850 <span className="text-sm text-gray-500">(promo)</span></div>
                      </td>
                      <td className="py-4 px-6 text-gray-600">$55/h</td>
                    </tr>
                    <tr className="hover:bg-gray-50 transition-colors">
                      <td className="py-4 px-6 text-gray-900">SAT Math Score<br/>Breakthrough Intensive</td>
                      <td className="py-4 px-6 text-gray-600">14h<br/>32h</td>
                      <td className="py-4 px-6">
                        <div className="text-green-600 font-semibold">$1020 <span className="text-sm text-gray-500">(promo)</span></div>
                        <div className="text-green-600 font-semibold">$2304 <span className="text-sm text-gray-500">(promo)</span></div>
                      </td>
                      <td className="py-4 px-6 text-gray-600">$73/h<br/>$64/h</td>
                    </tr>
                    <tr className="hover:bg-gray-50 transition-colors">
                      <td className="py-4 px-6 text-gray-900">ACT Math Score<br/>Breakthrough Intensive</td>
                      <td className="py-4 px-6 text-gray-600">14h<br/>32h</td>
                      <td className="py-4 px-6">
                        <div className="text-green-600 font-semibold">$1020 <span className="text-sm text-gray-500">(promo)</span></div>
                        <div className="text-green-600 font-semibold">$2304 <span className="text-sm text-gray-500">(promo)</span></div>
                    ...
                    <tr className="hover:bg-gray-50 transition-colors">
                      <td className="py-4 px-6 text-gray-900">SAT/ACT Math 1-on-1<br/>Elite Tutoring</td>
                      <td className="py-4 px-6 text-gray-600">Flexible Scheduling</td>
                      <td className="py-4 px-6 text-green-600 font-semibold">$</td>
                      <td className="py-4 px-6 text-gray-600">$100-215/h</td>
                    </tr>
                  </tbody>
                </table>
              </div>
      ...
      <section className="py-24 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 bg-green-50 px-4 py-2 rounded-full mb-6">
              <span className="text-2xl">📋</span>
              <span className="text-green-700 font-medium">Get Started</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Schedule Your Consultation</h2>
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
              Submit your details and our advisor will contact you within 24 hours to discuss your child's learning goals.
            </p>
          </div>

          <div className="bg-white rounded-3xl shadow-xl p-10 md:p-12 max-w-3xl mx-auto border border-gray-100">
            <form className="space-y-6" onSubmit={handleFormSubmit}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-gray-50 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all text-gray-900 placeholder-gray-400"
                ...
                <div>
                  <label className="block text-gray-800 font-semibold mb-3 text-sm">
                    Target Country/City <span className="text-red-500">*</span>
                  </label>
                  <input
                    type="text"
                    name="targetCountry"
              ...
              <div>
                <label className="block text-gray-800 font-semibold mb-3 text-sm">
                  WeChat <span className="text-gray-400 font-normal">(Optional)</span>
                </label>
                <input
                  type="text"
                  name="wechat"
              ...
              <button
                type="submit"
                className="w-full px-8 py-4 bg-gradient-to-r from-green-500 to-green-600 text-white rounded-xl font-semibold hover:from-green-600 hover:to-green-700 transition-all duration-300 flex items-center justify-center gap-2 shadow-lg hover:shadow-xl transform hover:scale-105 mt-8"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16 max-w-3xl mx-auto">
            <div className="text-center p-6 bg-white rounded-2xl border border-gray-100 hover:shadow-lg transition-shadow">
